...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $dir = dirname($this->get_server_var('SCRIPT_FILENAME')).'/';
		...
		*/
                'thumbnail' => array(
                    ...
                    'max_height' => 170 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
            'print_response' => true
        );
    ...
    protected function get_user_path() {
        if ($this->options['user_dirs']) {
            ...
            $path_user = $id_type.'/'.$this->get_user_id().'/photos'.'/';
            return $path_user;
        }
        return '';
    }
