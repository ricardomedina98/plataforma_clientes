<?php
    ...
    $contacts = ContactController::controllerSearchContacts($base, $tope);
?>
    ...
    <section class="content">
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <select class="form-control" name="filterState" id="addressState" data-live-search="true">
                                            <?php
                                                echo '<input id="valState" value="' . $requestContact['state'] . '" hidden>';
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <select class="form-control" name="filterCity" id="addressCity" data-live-search="true">  
                                            ...
                                            <?php
                                                echo '<input id="valCity" value="' . $requestContact['city'].'" hidden>';
                                            ?>                                          
      ...
      <div class="box box-success">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title">Contactos Buscados</h3>
        ...
        <div class="box-body no-padding">
                        ...
                        <div class="error-page">
                          ...
                          <div class="error-content">
                            ...
                            <p>
                              ...
                              Ingresa al seccion de contactos y allí podrás buscar.
          ...
          <div class="text-center">
            ...
            <?php
                ...
                $totalContacts = $contacts['countResult']; 
